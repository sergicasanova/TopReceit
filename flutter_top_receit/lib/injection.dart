...
void configureDependencies() async {
  ...
  sl.registerFactory<RecipeBloc>(() =>
      RecipeBloc(sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl(), sl()));
  ...
  sl.registerLazySingleton<GetPublicRecipesByUserIdUseCase>(
    () => GetPublicRecipesByUserIdUseCase(sl()),
  );
  sl.registerLazySingleton<GetPublicRecipesByFollowingUseCase>(
    () => GetPublicRecipesByFollowingUseCase(sl()),
  );
